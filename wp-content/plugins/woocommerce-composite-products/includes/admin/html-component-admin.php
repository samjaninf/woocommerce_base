	...
	<div class="bto_group_data wc-metabox-content">
		...
		foreach ( $tabs as $tab_id => $tab_values ) {
			...
			?><div class="options_group options_group_<?php echo $tab_id; ?> <?php echo $tab_loop > 0 ? 'options_group_hidden' : ''; ?>"><?php
				...
				/**
				 * woocommerce_composite_component_admin_config_html hook:
				 *
				 * @hooked component_config_title        - 10
				 * @hooked component_config_description  - 15
				 * @hooked component_config_options      - 20
				 * @hooked component_config_quantity_min - 25
				 * @hooked component_config_quantity_max - 33
				 * @hooked component_config_discount     - 35
				 * @hooked component_config_optional     - 40
				 *
				 *
				 * woocommerce_composite_component_admin_advanced_html hook:
				 *
				 * @hooked component_config_default_option           -   5
				 * @hooked component_sort_filter_show_orderby        -  10
				 * @hooked component_sort_filter_show_filters        -  15
				 * @hooked component_layout_hide_product_title       -  20
				 * @hooked component_layout_hide_product_description -  25
				 * @hooked component_layout_hide_product_thumbnail   -  30
				 * @hooked component_id_marker                       - 100
				 *
				 */
