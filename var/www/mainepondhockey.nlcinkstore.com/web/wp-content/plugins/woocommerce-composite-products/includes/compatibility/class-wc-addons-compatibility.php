...
class WC_CP_Addons_Compatibility {
	...
	public static function init() {
		...
		add_filter( 'woocommerce_composite_component_add_to_cart_validation', array( __CLASS__, 'validate_component_nyp_and_addons' ), 10, 5 );
	 ...
	 * @return bool
	 */
	public static function validate_component_nyp_and_addons( $add, $composite_id, $component_id, $product_id, $quantity ) {
