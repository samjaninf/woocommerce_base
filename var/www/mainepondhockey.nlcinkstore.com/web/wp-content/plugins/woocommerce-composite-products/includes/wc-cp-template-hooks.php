...
add_action( 'woocommerce_composite_component_selections_progressive', 'wc_cp_component_selections_message', 40, 2 );
 ...
 * Note:
 *
 * When component options loaded via ajax are appended instead of paginated (@see WC_Product_Composite::paginate_component_options),
