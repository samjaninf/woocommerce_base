...
?><div id="composite_summary_<?php echo $product->id; ?>" class="composite_summary <?php echo esc_attr( $summary_classes ); ?>" data-columns="<?php echo esc_attr( $summary_columns ); ?>" <?php echo $hidden ? 'style="display:none;"' : ''; ?>><?php
