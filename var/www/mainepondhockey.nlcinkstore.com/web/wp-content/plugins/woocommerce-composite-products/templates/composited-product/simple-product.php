...
?><div class="details component_data" data-component_set="true" data-price="<?php echo esc_attr( $price ); ?>" data-regular_price="<?php echo esc_attr( $regular_price ); ?>" data-product_type="simple" data-custom="<?php echo esc_attr( json_encode( $custom_data ) ); ?>"><?php
