...
class wpie_product_cat {

    function __construct() {

        add_action('wp_ajax_wpie_get_filter_product_cat_results', array(&$this, 'wpie_get_filter_product_cat_results'));
    ...
    function wpie_get_filter_product_cat_results() {
        global $wpie_product, $wpie_product_cat;

        $wpie_product->wpie_set_time_limit(0);

        $product_cat_list = $wpie_product_cat->get_filter_product_cat($_POST);

        $product_cat_fields = $wpie_product_cat->get_updated_product_cat_fields();
        ...
        <div class="wpie_filter_data_container">
            ...
            <table class="wpie_product_cat_filter_data">
                <thead>
                    <tr>
                        <th></th>
                        ...
                        foreach ($product_cat_list as $product_cat_data) {
                            ...
                            <tr>
                                ...
                                foreach ($product_cat_fields['product_cat_fields'] as $product_cat_info) {
                                    $temp_data = $product_cat_info['field_key'];
                                    ?>
                                    <td><?php echo isset($product_cat_data->$temp_data) ? $product_cat_data->$temp_data : ""; ?></td>
                                <?php }
                                ?>
                            </tr>
                            <?php
    ...
    function get_new_product_cat_fields() {
        global $wpie_product_cat;

        $product_cat_fields = maybe_serialize($wpie_product_cat->get_product_cat_fields());
    ...
    function get_updated_product_cat_fields() {
        ...
        $old_product_cat_fields = $wpie_product_cat->get_new_product_cat_fields();
    ...
    function get_product_cat_export_data($wpie_data = array()) {
        ...
        $product_cat_field_list = $wpie_product_cat->get_updated_product_cat_fields();

        $product_cat_list_data = $wpie_product_cat->get_filter_product_cat($wpie_data);
    ...
    function save_product_cat_scheduled() {
        ...
        if ($wpie_export_interval != "") {
            ...
            wp_schedule_event(time(), $wpie_export_interval, 'wpie_cron_scheduled_product_cat_export', array($scheduled_id));
    ...
    function wpie_save_product_cat_fields() {
        ...
        $old_product_cat_fields = $wpie_product_cat->get_updated_product_cat_fields();
        ...
        foreach ($old_product_cat_fields as $product_cat_fields_key => $product_cat_fields_data) {
            foreach ($product_cat_fields_data as $key => $value) {
                ...
                $new_fields[$product_cat_fields_key][$key]['field_value'] = isset($_POST['wpie_' . $value['field_key'] . '_field']) ? $_POST['wpie_' . $value['field_key'] . '_field'] : "";
            }
        }
    ...
    function wpie_import_products_cat() {
        ...
        if ($file_path != "") {
            ...
            if ($fh !== FALSE) {
                ...
                $return_value['success_log'] = '<div class="wpie_success_msg wpie_product_cat_import_success_msg">' . __('Product Categories Imported successfully.', WPIE_TEXTDOMAIN) . '</div>';
            } else {

                $return_value['message_text'] = __('Could not open file.', WPIE_TEXTDOMAIN);
            }
            if (!empty($import_data)) {
                $product_cat_updated_data = $wpie_product_cat->wpie_create_new_product_cat($import_data);

                $return_value['data'] = @$product_cat_updated_data['data'];

                $return_value['product_cat_log'] = $wpie_product_cat->set_product_cat_import_errors($product_cat_updated_data['product_cat_log']);
            }
        }
    ...
    function wpie_create_new_product_cat($product_cat_data = array()) {
        global $wpie_product, $wpie_product_cat;
        ...
        $wpie_product_cat_log = array();

        $product_cat_create_method = isset($_POST['wpie_product_cat_create_method']) ? $_POST['wpie_product_cat_create_method'] : "";
        ...
        foreach ($product_cat_data as $product_cat_info) {
            ...
            if (isset($product_cat_info['slug']) && $product_cat_info['slug'] != "" && ($product_cat_create_method == 'update_product_cat' || $product_cat_create_method == 'skip_product_cat')) {
                ...
                if ($product_cat_create_method == 'skip_product_cat' && $current_cat_id != "" && $current_cat_id > 0) {
                    $imported_ids['wpie_product_category'][] = $current_cat_id;

                    $wpie_product_cat_log[] = sprintf(__('Product Category #%d %s already Exist.', WPIE_TEXTDOMAIN), $current_cat_id, $product_cat_info['name']);
            ...
            if (isset($product_cat_info['category_image']) && $product_cat_info['category_image'] != "") {
                $wpie_product_cat_log[] = $wpie_product_cat->wpie_get_product_cat_image($product_cat_info['category_image'], $product_cat_data['term_id']);
            }

            $imported_ids['wpie_product_category'][] = $product_cat_data['term_id'];
        ...
        $product_all_data['data'] = $wpie_product_cat->get_imported_product_cat($imported_ids);

        $product_all_data['product_cat_log'] = $wpie_product_cat_log;
    ...
    function get_imported_product_cat($product_cat_ids = array()) {
        ...
        $product_cat_list = $wpie_product_cat->get_filter_product_cat($product_cat_ids);
    ...
    function set_product_cat_import_errors($product_cat_errors = array()) {
        ...
        if (!empty($product_all_errors)) {
            foreach ($product_all_errors as $wpie_error) {
                ?>
                <div class="wpie_error_msg wpie_import_product_cat_error_log"><?php echo $wpie_error; ?></div>
                <?php
            }
        }
